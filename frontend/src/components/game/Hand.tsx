...
export const Hand = ({
  ...
  return (
    <TactileContainer className="relative h-44 flex-none !flex-col !items-stretch !justify-end !p-3">
      <h2 className="absolute left-4 top-2 text-lg uppercase text-white">
        Twoja ręka
      </h2>

      <div className="flex h-full items-end justify-center gap-3 pt-2">
        {sorted.length === 0 ? (
