...
const GamePage = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col gap-5 overflow-hidden bg-[#e53935] p-5 font-bold">
      <div className="grid min-h-0 flex-1 grid-cols-[14rem_1fr_14rem_18rem] gap-5">
        <PlayersPanel
